...
public:
  ...
  // Comparison operators
  bool operator==(const PreOrderFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
  bool operator!=(const PreOrderFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
...
public:
  ...
  // Comparison operators
  bool operator==(const PostOrderFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
  bool operator!=(const PostOrderFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
...
public:
  ...
  // Comparison operators
  bool operator==(const InOrderFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
  bool operator!=(const InOrderFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
...
public:
  ...
  // Comparison operators
  bool operator==(const BreadthFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
  bool operator!=(const BreadthFoldableContainer&) = delete; // Comparison of abstract types might not be possible.
