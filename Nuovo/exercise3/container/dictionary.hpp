...
public:
  ...
  virtual bool InsertSome(const MappableContainer<Data>&, ulong)  = 0; // Copy of the value; From MappableContainer; True if some is inserted
  virtual bool InsertSome(MutableMappableContainer<Data>&&, ulong) noexcept = 0; // Move of the value; From MutableMappableContainer; True if some is inserted
  virtual bool RemoveSome(const MappableContainer<Data>&, ulong) = 0; // From MappableContainer; True if some is removed
